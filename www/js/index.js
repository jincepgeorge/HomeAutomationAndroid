...
angular.module("app", ["chart.js", "AWSDynamoService"]).controller("LineCtrl", function($scope, AWSDynamoService) {
                                                                   ...
                                                                   $("#nowAcPower").html('<strong>' + acPower + '</strong>');
                                                                   $("#nowAcPower").css("background", "none");
                                                                   $("#nowAcFanStatus").html('<strong>' + acFanStatus + '</strong>');
                                                                   $("#nowAcFanStatus").css("background", "none");
                                                                   $("#nowSwingStatus").html('<strong>' + swingStatus + '</strong>');
                                                                   $("#nowSwingStatus").css("background", "none");
                                                                   ...
                                                                   labelArray.reverse();
                                                                   climateTempArray.reverse();
                                                                   climateHumArray.reverse();
                                                                   piTemperatureArray.reverse();
                                                                   ...
                                                                   $scope.showDeviceParams = function(points, evt) {
                                                                   $("#deviceParams").toggle();
                                                                   ...
                                                                   $scope.setTriggerPoint = function() {
                                                                
                                                                   $('#triggerPintModel').modal('show');
                                                                   /*send({
                                                                        "temperature": "23",
                                                                        "humidity": "40"
                                                                        }, "triggerpoint");*/
                                                                   ...
                                                                   $scope.submitTriggerValues = function() {
                                                                  
                                                                 
                                                                   var jsondata={temp:$scope.temperature,hum:$scope.humidity};
                                                                   send(JSON.stringify(jsondata), "triggerpoint");
                                                                    $('#triggerPintModel').modal('hide');
...
function onMessage(message) {
    ...
    if (message.payloadString == 'acpoweron') {
        $("#nowAcPower").html('<strong>ON</strong>');
        $("#nowAcPower").css("background", "none");
        
    } else if (message.payloadString == 'acpoweroff') {
        $("#nowAcPower").html('<strong>OFF</strong>');
        $("#nowAcPower").css("background", "none");
        
    } else if (message.payloadString == 'swingon') {
        $("#nowSwingStatus").html('<strong>ON</strong>');
        $("#nowSwingStatus").css("background", "none");
        
    } else if (message.payloadString == 'swingoff') {
        $("#nowSwingStatus").html('<strong>OFF</strong>');
        $("#nowSwingStatus").css("background", "none");
        
    } else if (message.payloadString == 'fanoff') {
        $("#nowAcFanStatus").html('<strong>OFF</strong>');
        $("#nowAcFanStatus").css("background", "none");
        
    } else if (message.payloadString == 'fanon') {
        $("#nowAcFanStatus").html('<strong>ON</strong>');
        $("#nowAcFanStatus").css("background", "none");
        
    }
    //angular.element($("#bodyCntrl")).scope().loadData();
...
function onDeviceReady() {
    ...
    //cordova.exec(function(){}, function(){}, "PushPlugin", "register", []);
    ...
    push.on('registration', function(data) {
            ...
            console.log(data.registrationId);
             ...
             var tokenUrl = 'http://eyiottokenmaster-eyiot.rhcloud.com/inserttoken/'+data.registrationId+'/android';
            $.ajax({url: tokenUrl, success: function(result){
